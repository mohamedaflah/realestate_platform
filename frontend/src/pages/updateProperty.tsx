...
export const UpdateProperty = () => {
  ...
  useEffect(() => {
    axiosInstance.get(`/property/${propertyId}`).then((res) => {
      ...
      setValue("propertyType", String(res.data.property?.propertyType));
      ...
      setValue("address.city", String(res.data.property?.address?.city));
      setValue("address.state", String(res.data.property?.address?.state));
      setValue("address.country", String(res.data.property?.address?.country));
      setValue("address.zipcode", String(res.data.property?.address?.zipcode));
              ...
              <div className="flex flex-col gap-1 ">
                ...
                >
                  <SelectTrigger className="w-full">
                    <SelectValue placeholder={watch("propertyType")} />
                  </SelectTrigger>
                  <SelectContent>
